...
interface BaseFeeCollectorInterface {
    ...
    function withdrawERC20Tokens(address withdrawalWallet, address tokenContract, uint256 amount) external;
    ...
    function isWithdrawalWallet(address withdrawalWallet) external view returns (bool);
}
