...
interface BaseFeeCollectorEventsAndErrors {
    ...
    error BadReturnValueFromERC20OnTransfer(address token, address to, uint256 amount);
    ...
    error TokenTransferGenericFailure(address token, address to, uint256 identifier, uint256 amount);
}
