...
contract BaseFeeCollector is Ownable, BaseFeeCollectorInterface, BaseFeeCollectorEventsAndErrors {
    ...
    function withdrawERC20Tokens(address withdrawalWallet, address tokenContract, uint256 amount)
        external
        override
        isOperator
    {
        ...
        (bool result, bytes memory data) =
            tokenContract.call(abi.encodeWithSelector(IERC20.transfer.selector, withdrawalWallet, amount));
