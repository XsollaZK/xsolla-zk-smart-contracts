...
contract ERC721Factory is Ownable {
    ...
    string public constant IPFS_DEFAULT_IMAGE = "bafkreie7ohywtosou76tasm7j63yigtzxe7d5zqus4zu3j6oltvgtibeom"; // Hello
        // IPFS image.
    ...
    function deployDefaultCollection(string memory _name, string memory _symbol) external {
        ERC721Modular collection = new ERC721Modular(_name, _symbol, DEFAULT_MAX_SUPPLY);
    ...
    function deployCollection(
        ...
        ERC721Modular collection = new ERC721Modular(_name, _symbol, _maxSupply);
