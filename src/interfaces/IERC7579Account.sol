...
interface IERC7579Account {
    ...
    /// @param initData arbitrary data that may be required on the module during
    ...
    /// @param moduleTypeId the module type ID according the ERC-7579 spec
    /// @param module the module address
    /// @param deInitData arbitrary data that may be required on the module
    ...
    /// module type Id @param moduleTypeId the module type ID according the
    /// ERC-7579 spec
