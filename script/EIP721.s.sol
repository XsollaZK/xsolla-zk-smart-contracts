...
import { ERC721Factory } from "src/token/ERC721/ERC721Factory.sol";
import { ERC721Modular } from "src/token/ERC721/extensions/ERC721Modular.sol";
import { ERC721Claimer } from "src/token/ERC721/ERC721Claimer.sol";
...
contract EIP721 is Autowirable {
    ...
    function run() public {
        ...
        modularERC721 = new ERC721Modular("Xsolla NFT Collection", "XSOLLA_NFT", 10_000);
    ...
    function deployBasicERC721(string memory name, string memory symbol, uint256 maxSupply)
        external
        returns (ERC721Modular)
    {
        vm.startBroadcast();
    ...
    function deployERC721WithClaimer(string memory name, string memory symbol, uint256 maxSupply, uint256 claimAmount)
        external
        returns (ERC721Modular, ERC721Claimer)
    {
        vm.startBroadcast();
    ...
    function deployMinimalERC721(string memory name, string memory symbol, uint256 maxSupply)
        external
        returns (ERC721Modular)
    {
        vm.startBroadcast();
