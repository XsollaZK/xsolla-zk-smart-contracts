...
import { ERC1155Factory } from "src/token/ERC1155/ERC1155Factory.sol";
import { ERC1155Modular } from "src/token/ERC1155/extensions/ERC1155Modular.sol";
import { ERC1155Claimer } from "src/token/ERC1155/ERC1155Claimer.sol";

import { Autowirable } from "script/di/Autowirable.s.sol";

contract EIP1155 is Autowirable {
